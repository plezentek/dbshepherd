...
# Bazel doesn't handle inter-rule dependencies very well.  Each package just
# imports whatever minimum version they need if they are loaded before the
# package they depend on.

# This section is for the rules that we need to import early to get up-to-date
# versions: rules_python and rules_go
http_archive(
    name = "rules_python",
...
go_repository(
    name = "com_github_unrolled_logger",
    importpath = "github.com/unrolled/logger",
    sum = "h1:EvwTdlXPJXfsN/6dXk+APSGfsGcBdHac6Cd3h7e2fao=",
    version = "v0.0.0-20190327162521-be1a2406c7c9",
)
